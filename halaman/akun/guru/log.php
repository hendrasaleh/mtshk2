...
// ini untuk melihat akun yang masuk
$pelaku = isset($username) ? $username : 'Not detected';

// ini untuk mendeteksi file yang diupload
$file = isset($namaFile) ? $namaFile : 'No File';
...
$entry_line = "Waktu: $dtime | Username: $pelaku | IP asli: $ip | Browser: $agent? | URL: $uri | Referrer: $ref | Proxy: $asli | Koneksi: $via | File: $file
...
$fp = fopen("log_guru_".date("m-Y").".txt", "a");
